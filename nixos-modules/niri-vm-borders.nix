...
#
# When `nixling.site.ui.compositors.niri.enable = true` or the legacy
# `nixling.site.niriVmBorders.enable = true`, installs a KDL file
...
let
  legacyCfg = config.nixling.site.niriVmBorders;
  cfg = config.nixling.site.ui.compositors.niri;
  vmsCfg = config.nixling.vms;
  colors = config.nixling._uiColors;
    ...
    assertions = [
      {
        ...
        message = ''
          nixling.site.ui.compositors.niri.outputPath must start with /etc/,
