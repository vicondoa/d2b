...
| [panel-review.md](./panel-review.md) | Phase gate, fix-round scope, shared worktree destructive-git rule, ten-role focus, and swarm and unattended-run harness notes. |
