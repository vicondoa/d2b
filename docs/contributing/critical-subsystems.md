...
**Where:** `packages/d2b-bus/tests/public_mint_surface.rs`, its four approved API snapshots, the mutations under `packages/d2b-bus/tests/ui/`, and the capability definitions in `packages/{d2b-bus,d2b-session,d2b-session-unix}/src/`
