...
- 0 findings applied / 0 skipped: lane net is zero - #C5/#C4/#B9 all verified still present at HEAD and are not class-(b) executable (wire-locked admission surface / refused classes / U97 consolidation targets). No changes to this crate.
