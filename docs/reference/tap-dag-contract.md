...
> the owner-local contract and generated-artifact checks.
...
- **Drift policy**: the owner-local contract and generated-artifact checks fail if any of the above implementation symbols diverge from this document.
- **Related references**:
