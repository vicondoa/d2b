...
Once the runtime codec dependency lands, guest endpoints receive their
generation, public identity bindings, channel binding, and optional one-shot
bootstrap PSK through the private runtime
