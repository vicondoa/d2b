...
`d2b-realm-core.json` snapshots the codec-neutral realm-core
model from `packages/d2b-realm-core`. It is generated by
`bazel run //packages/xtask:xtask -- gen-schemas` from `D2bRealmCoreSchema` and should not be
edited by hand.

This schema is **not** the local daemon, broker, or ComponentSession wire
