...
Schema: [`minijail-profile.json`](./minijail-profile.json) (forward reference; generated by W1 s1 with `cargo xtask gen-schemas`).
...
role is considered ready. W1 known carve-outs are limited to roles such
