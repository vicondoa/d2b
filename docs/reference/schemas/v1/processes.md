...
Schema: [`processes.json`](./processes.json) (forward reference; generated by W1 s1 with `cargo xtask gen-schemas`).
...
| `seccompPolicy` | string | yes | Policy ID or path reference. W1 stores references only, not syscall allowlists. |
