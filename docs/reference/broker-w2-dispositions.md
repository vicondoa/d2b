...
| ApplyNftablesProjection | stubbed-unimplemented | Returns `BrokerError::Unimplemented`; typed nftables projection reconciliation is not implemented. | reserved |
...
| CreateBridge | stubbed-unimplemented | Returns `BrokerError::Unimplemented`; typed bridge creation is not implemented. | reserved |
...
| DeleteBridge | stubbed-unimplemented | Returns `BrokerError::Unimplemented`; typed bridge deletion is not implemented. | reserved |
| DeletePersistentTap | stubbed-unimplemented | Returns `BrokerError::Unimplemented`; typed persistent TAP deletion is not implemented. | reserved |
