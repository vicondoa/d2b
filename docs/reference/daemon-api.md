...
| `ApplyNftablesProjectionRequest` | struct | [`ApplyNftablesProjectionRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L662) | struct { `bundle_nft_projection_intent_ref`: `BundleOpId`; `scope_id`: `ScopeId`; `action`: `NftablesProjectionAction`; `desired_hash`: `Option<String>`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `ApplyNmUnmanagedRequest` | struct | [`ApplyNmUnmanagedRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L674) | struct { `bundle_nm_intent_ref`: `BundleOpId`; `scope_id`: `ScopeId`; `destroy`: `bool`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `ApplyRouteRequest` | struct | [`ApplyRouteRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L685) | struct { `bundle_route_intent_ref`: `BundleOpId`; `scope_id`: `ScopeId`; `destroy`: `bool`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `ApplySysctlRequest` | struct | [`ApplySysctlRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L696) | struct { `bundle_sysctl_intent_ref`: `BundleOpId`; `scope_id`: `ScopeId`; `destroy`: `bool`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `BindUnixSocketRequest` | struct | [`BindUnixSocketRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L707) | struct { `bundle_socket_intent_ref`: `BundleOpId`; `vm_id`: `VmId`; `role_id`: `RoleId`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `CreateOrReconcileUsersGroupsRequest` | struct | [`CreateOrReconcileUsersGroupsRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L717) | struct { `subject_ids`: `Vec<SubjectId>`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `CreatePersistentTapRequest` | struct | [`CreatePersistentTapRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L731) | struct { `role_id`: `RoleId`; `vm_id`: `VmId`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `DeletePersistentTapRequest` | struct | [`DeletePersistentTapRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L743) | struct { `role_id`: `RoleId`; `vm_id`: `VmId`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `CreateBridgeRequest` | struct | [`CreateBridgeRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L756) | struct { `bundle_bridge_intent_ref`: `BundleOpId`; `scope_id`: `ScopeId`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `DeleteBridgeRequest` | struct | [`DeleteBridgeRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L767) | struct { `bundle_bridge_intent_ref`: `BundleOpId`; `scope_id`: `ScopeId`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `CreateTapFdRequest` | struct | [`CreateTapFdRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L778) | struct { `role_id`: `RoleId`; `vm_id`: `VmId`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `DelegateCgroupV2Request` | struct | [`DelegateCgroupV2Request`](../../packages/d2b-contracts/src/broker_wire.rs#L790) | struct { `scope_id`: `ScopeId`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `ExportBrokerAuditRequest` | struct | [`ExportBrokerAuditRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L798) | struct { `filter`: `Option<BrokerAuditFilter>`; `since`: `Option<String>` } |
| `GuestControlSignRequest` | struct | [`GuestControlSignRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L866) | struct { `vm_id`: `VmId`; `role`: `GuestControlProofRole`; `protocol_version`: `u32`; `direction`: `GuestControlDirection`; `purpose`: `GuestControlAuthPurpose`; `guest_control_port`: `u32`; `peer_cid`: `Option<u32>`; `host_nonce`: `Vec<u8>`; `guest_nonce`: `Vec<u8>`; `guest_boot_id`: `GuestBootIdWire`; `capabilities_hash`: `Option<String>`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `SecretByIdRequest` | struct | [`SecretByIdRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L921) | struct { `opaque_id`: `String`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `LaunchMinijailChildRequest` | struct | [`LaunchMinijailChildRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L933) | struct { `vm_id`: `VmId`; `role_id`: `RoleId`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `ModprobeIfAllowedRequest` | struct | [`ModprobeIfAllowedRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L947) | struct { `module_name`: `String`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `OpenCgroupDirRequest` | struct | [`OpenCgroupDirRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L957) | struct { `scope_id`: `ScopeId`; `path_class`: `PathClass`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `OpenDeviceRequest` | struct | [`OpenDeviceRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L966) | struct { `role_id`: `RoleId`; `device_class`: `String`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `OpenKvmRequest` | struct | [`OpenKvmRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L975) | struct { `role_id`: `RoleId`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `QemuMediaEnrollRequest` | struct | [`QemuMediaEnrollRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L989) | struct { `vm_id`: `VmId`; `media_ref`: `MediaRef`; `bus_id`: `String`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `QemuMediaRefreshRegistryRequest` | struct | [`QemuMediaRefreshRegistryRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L1010) | struct { `tracing_span_id`: `Option<TracingSpanId>` } |
| `QemuMediaBootRequest` | struct | [`QemuMediaBootRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L1032) | struct { `vm_id`: `VmId`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `QemuMediaLifecycleRequest` | struct | [`QemuMediaLifecycleRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L1040) | struct { `vm_id`: `VmId`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `QemuMediaQueryStatusRequest` | struct | [`QemuMediaQueryStatusRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L1048) | struct { `vm_id`: `VmId`; `shutdown_context`: `bool`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `QemuMediaHotplugRequest` | struct | [`QemuMediaHotplugRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L1113) | struct { `vm_id`: `VmId`; `bus_id`: `String`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `OpenPidfdRequest` | struct | [`OpenPidfdRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L1171) | struct { `vm_id`: `VmId`; `role_id`: `RoleId`; `pid`: `i32`; `expected_start_time_ticks`: `u64`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `OpenVhostNetRequest` | struct | [`OpenVhostNetRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L1207) | struct { `role_id`: `RoleId`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `OpenFuseRequest` | struct | [`OpenFuseRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L1215) | struct { `role_id`: `RoleId`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `OpenHidrawSecurityKeyRequest` | struct | [`OpenHidrawSecurityKeyRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L1227) | struct { `vm_id`: `VmId`; `selector_id`: `String`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `PrepareDirRequest` | struct | [`PrepareDirRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L1255) | struct { `vm_id`: `VmId`; `path_class`: `PathClass`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `PrepareStoreViewRequest` | struct | [`PrepareStoreViewRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L1264) | struct { `vm_id`: `VmId`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `StoreSyncRequest` | struct | [`StoreSyncRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L1284) | struct { `vm_id`: `VmId`; `bundle_closure_ref`: `BundleClosureRef`; `generation_token`: `u32`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `StoreVerifyRequest` | struct | [`StoreVerifyRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L1321) | struct { `vm_id`: `VmId`; `repair`: `bool`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `SetBridgePortFlagsRequest` | struct | [`SetBridgePortFlagsRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L1380) | struct { `vm_id`: `VmId`; `role_id`: `RoleId`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `SetSocketAclRequest` | struct | [`SetSocketAclRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L1389) | struct { `bundle_socket_intent_ref`: `BundleOpId`; `vm_id`: `VmId`; `role_id`: `RoleId`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `SetupMountNamespaceRequest` | struct | [`SetupMountNamespaceRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L1399) | struct { `vm_id`: `VmId`; `role_id`: `RoleId`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `UpdateHostsFileRequest` | struct | [`UpdateHostsFileRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L1410) | struct { `bundle_hosts_intent_ref`: `BundleOpId`; `destroy`: `bool`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `UsbipBindRequest` | struct | [`UsbipBindRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L1423) | struct { `bundle_usbip_bind_intent_ref`: `BundleOpId`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `UsbipBindFirewallRuleRequest` | struct | [`UsbipBindFirewallRuleRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L1440) | struct { `bundle_usbip_firewall_intent_ref`: `BundleOpId`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `UsbipProxyReconcileRequest` | struct | [`UsbipProxyReconcileRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L1448) | struct { `scope_id`: `ScopeId`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `UsbipUnbindRequest` | struct | [`UsbipUnbindRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L1456) | struct { `bundle_usbip_bind_intent_ref`: `BundleOpId`; `preserve_durable_claim`: `bool`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `UsbipExplicitBindRequest` | struct | [`UsbipExplicitBindRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L1478) | struct { `bus_id`: `String`; `vm`: `String`; `env`: `String`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `UsbipExplicitFirewallRuleRequest` | struct | [`UsbipExplicitFirewallRuleRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L1496) | struct { `bus_id`: `String`; `env`: `String`; `host_uplink_ip`: `String`; `net_uplink_ip`: `String`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `SignalRunnerRequest` | struct | [`SignalRunnerRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L1558) | struct { `vm_id`: `VmId`; `role_id`: `RoleId`; `signal`: `RunnerSignal`; `pid`: `Option<i32>`; `expected_start_time_ticks`: `Option<u64>`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `DeregisterRunnerPidfdRequest` | struct | [`DeregisterRunnerPidfdRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L1580) | struct { `vm_id`: `VmId`; `role_id`: `RoleId`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `SpawnRunnerRequest` | struct | [`SpawnRunnerRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L1669) | struct { `vm_id`: `VmId`; `role_id`: `RoleId`; `role`: `RunnerRole`; `bundle_runner_intent_ref`: `BundleOpId`; `runtime_allocations`: `Vec<RunnerAllocation>`; `tracing_span_id`: `Option<TracingSpanId>`; `workload_identity`: `Option<WorkloadIdentity>` } |
| `SeedDnsmasqLeaseRequest` | struct | [`SeedDnsmasqLeaseRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L1833) | struct { `vm_id`: `VmId`; `scope_id`: `ScopeId`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `BindMountFromHardlinkFarmRequest` | struct | [`BindMountFromHardlinkFarmRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L1845) | struct { `vm_id`: `VmId`; `bundle_store_view_intent_ref`: `Option<BundleOpId>`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `OwnershipMatrixCheckRequest` | struct | [`OwnershipMatrixCheckRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L1860) | struct { `vm_id`: `VmId`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `SshHostKeyPreflightRequest` | struct | [`SshHostKeyPreflightRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L1871) | struct { `vm_id`: `VmId`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `ReconcileStorageScopeRequest` | struct | [`ReconcileStorageScopeRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L1885) | struct { `storage_ref`: `BundleOpId`; `apply`: `bool`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `ValidateLockSpecRequest` | struct | [`ValidateLockSpecRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L1922) | struct { `lock_ref`: `BundleOpId`; `tracing_span_id`: `Option<TracingSpanId>` } |
| `DiskInitRequest` | struct | [`DiskInitRequest`](../../packages/d2b-contracts/src/broker_wire.rs#L1956) | struct { `vm_id`: `VmId`; `tracing_span_id`: `Option<TracingSpanId>` } |
...
| `HelloResponse` | struct | [`HelloResponse`](../../packages/d2b-contracts/src/broker_wire.rs#L619) | struct { `server_version`: `String`; `selected_version`: `String`; `capabilities`: `Vec<String>` } |
| `GuestControlSignResponse` | struct | [`GuestControlSignResponse`](../../packages/d2b-contracts/src/broker_wire.rs#L914) | struct { `tag`: `Vec<u8>` } |
| `QemuMediaEnrollResponse` | struct | [`QemuMediaEnrollResponse`](../../packages/d2b-contracts/src/broker_wire.rs#L999) | struct { `vm_id`: `VmId`; `media_ref`: `MediaRef`; `read_only`: `bool`; `enrolled`: `bool`; `udev_rule_written`: `bool`; `udev_reloaded`: `bool` } |
| `QemuMediaRefreshRegistryResponse` | struct | [`QemuMediaRefreshRegistryResponse`](../../packages/d2b-contracts/src/broker_wire.rs#L1017) | struct { `record_count`: `u32`; `redacted_index_written`: `bool`; `udev_rule_written`: `bool`; `udev_reloaded`: `bool` } |
| `QemuMediaLifecycleResponse` | struct | [`QemuMediaLifecycleResponse`](../../packages/d2b-contracts/src/broker_wire.rs#L1093) | struct { `vm_id`: `VmId`; `command`: `QemuMediaLifecycleAction` } |
| `QemuMediaQueryStatusResponse` | struct | [`QemuMediaQueryStatusResponse`](../../packages/d2b-contracts/src/broker_wire.rs#L1100) | struct { `vm_id`: `VmId`; `status`: `QemuMediaVmStatus` } |
| `QemuMediaHotplugResponse` | struct | [`QemuMediaHotplugResponse`](../../packages/d2b-contracts/src/broker_wire.rs#L1143) | struct { `vm_id`: `VmId`; `media_ref`: `MediaRef`; `slot`: `String`; `read_only`: `bool`; `qmp_commands`: `Vec<String>`; `events`: `Vec<QemuMediaHotplugEvent>` } |
| `OpenPidfdResponse` | struct | [`OpenPidfdResponse`](../../packages/d2b-contracts/src/broker_wire.rs#L1192) | struct { `vm_id`: `VmId`; `role_id`: `RoleId`; `pid`: `i32`; `verified_start_time_ticks`: `u64`; `pidfd_index`: `u32` } |
| `OpenHidrawSecurityKeyResponse` | struct | [`OpenHidrawSecurityKeyResponse`](../../packages/d2b-contracts/src/broker_wire.rs#L1242) | struct { `selector_resolved`: `String`; `device_class`: `String` } |
| `StoreSyncResponse` | struct | [`StoreSyncResponse`](../../packages/d2b-contracts/src/broker_wire.rs#L1305) | struct { `vm`: `String`; `generation_id`: `String`; `generation_token`: `u32`; `hardlink_farm_path`: `String`; `closure_count`: `u32`; `retained_generations`: `Vec<u32>`; `swept_count`: `u32`; `cleanup_deferred`: `bool` } |
| `StoreVerifyResponse` | struct | [`StoreVerifyResponse`](../../packages/d2b-contracts/src/broker_wire.rs#L1354) | struct { `vm`: `String`; `status`: `StoreVerifyStatus`; `checked`: `u32`; `drifted`: `u32`; `repaired`: `u32`; `unknown_reason`: `Option<StoreVerifyUnknownReason>`; `audit_ref`: `Option<String>`; `remediation`: `Option<String>` } |
| `AckResponse` | struct | [`AckResponse`](../../packages/d2b-contracts/src/broker_wire.rs#L1511) | struct { `accepted`: `bool`; `operation`: `String` } |
| `TapReadyResponse` | struct | [`TapReadyResponse`](../../packages/d2b-contracts/src/broker_wire.rs#L1518) | struct { `bridge`: `Option<IfName>`; `tap`: `IfName` } |
| `ExportBrokerAuditResponse` | struct | [`ExportBrokerAuditResponse`](../../packages/d2b-contracts/src/broker_wire.rs#L1525) | struct { `lines`: `Vec<String>` } |
| `BridgePortFlagsResponse` | struct | [`BridgePortFlagsResponse`](../../packages/d2b-contracts/src/broker_wire.rs#L1531) | struct { `bridge`: `IfName`; `isolated`: `bool`; `neigh_suppress`: `bool`; `port`: `IfName` } |
| `ValidateBundleResponse` | struct | [`ValidateBundleResponse`](../../packages/d2b-contracts/src/broker_wire.rs#L1540) | struct { `valid`: `bool` } |
| `SignalRunnerResponse` | struct | [`SignalRunnerResponse`](../../packages/d2b-contracts/src/broker_wire.rs#L1572) | struct { `signaled`: `bool`; `vm_id`: `VmId`; `role_id`: `RoleId` } |
| `DeregisterRunnerPidfdResponse` | struct | [`DeregisterRunnerPidfdResponse`](../../packages/d2b-contracts/src/broker_wire.rs#L1589) | struct { `vm_id`: `VmId`; `role_id`: `RoleId`; `removed`: `bool` } |
| `SpawnRunnerResponse` | struct | [`SpawnRunnerResponse`](../../packages/d2b-contracts/src/broker_wire.rs#L1742) | struct { `vm_id`: `VmId`; `role_id`: `RoleId`; `role`: `RunnerRole`; `pid`: `i32`; `start_time_ticks`: `u64`; `pidfd_index`: `u32`; `console_fd_index`: `Option<u32>` } |
| `ReconcileStorageScopeResponse` | struct | [`ReconcileStorageScopeResponse`](../../packages/d2b-contracts/src/broker_wire.rs#L1906) | struct { `storage_ref`: `BundleOpId`; `scope`: `String`; `kind`: `String`; `status`: `StorageReconcileStatus`; `applied`: `bool`; `path_hash`: `String` } |
| `ValidateLockSpecResponse` | struct | [`ValidateLockSpecResponse`](../../packages/d2b-contracts/src/broker_wire.rs#L1930) | struct { `lock_ref`: `BundleOpId`; `scope`: `String`; `kind`: `String`; `cloexec_required`: `bool`; `fd_passing_mechanism`: `String`; `order_key`: `String` } |
| `PollChildReapedResponse` | struct | [`PollChildReapedResponse`](../../packages/d2b-contracts/src/broker_wire.rs#L2017) | struct { `notifications`: `Vec<ChildReapedNotification>` } |
...
| `GuestControlProofRole` | enum | [`GuestControlProofRole`](../../packages/d2b-contracts/src/broker_wire.rs#L813) | `HostProof`; `GuestProof` |
| `GuestControlDirection` | enum | [`GuestControlDirection`](../../packages/d2b-contracts/src/broker_wire.rs#L820) | `HostToGuest` |
| `GuestControlAuthPurpose` | enum | [`GuestControlAuthPurpose`](../../packages/d2b-contracts/src/broker_wire.rs#L826) | `GuestControlAuthV1` |
| `QemuMediaLifecycleAction` | enum | [`QemuMediaLifecycleAction`](../../packages/d2b-contracts/src/broker_wire.rs#L1062) | `SystemPowerdown`; `Quit` |
| `QemuMediaVmStatus` | enum | [`QemuMediaVmStatus`](../../packages/d2b-contracts/src/broker_wire.rs#L1069) | `Running`; `Paused`; `Shutdown`; `Suspended`; `Watchdog`; `Debug`; `Inmigrate`; `InternalError`; `IoError`; `Postmigrate`; `Prelaunch`; `FinishMigrate`; `RestoreVm`; `SaveVm`; `GuestPanicked`; `Colo`; `Preconfig`; `Unknown`; `ConnectionLostDuringShutdown` |
| `QemuMediaHotplugStatus` | enum | [`QemuMediaHotplugStatus`](../../packages/d2b-contracts/src/broker_wire.rs#L1122) | `IdentityResolved`; `QmpConnected`; `QmpCapabilities`; `FdAdded`; `BlockdevAdded`; `DeviceAdded`; `DeviceDeleted`; `BlockdevDeleted`; `FdRemoved`; `VmContinued` |
| `StoreVerifyStatus` | enum | [`StoreVerifyStatus`](../../packages/d2b-contracts/src/broker_wire.rs#L1331) | `Ok`; `Drift`; `Unknown`; `Repaired`; `Failed`; `NotFound` |
| `StoreVerifyUnknownReason` | enum | [`StoreVerifyUnknownReason`](../../packages/d2b-contracts/src/broker_wire.rs#L1342) | `MarkerOrManifestMissing`; `MarkerOrManifestUnreadable`; `OlderHostGeneration`; `GenerationIdentityUnavailable` |
| `RunnerSignal` | enum | [`RunnerSignal`](../../packages/d2b-contracts/src/broker_wire.rs#L1550) | `Term`; `Kill`; `Quit` |
| `RunnerRole` | enum | [`RunnerRole`](../../packages/d2b-contracts/src/broker_wire.rs#L1608) | `CloudHypervisor`; `QemuMedia`; `Virtiofsd`; `Swtpm`; `SwtpmFlush`; `Gpu`; `Audio`; `Video`; `VsockRelay`; `Usbip`; `OtelHostBridge`; `WaylandProxy` |
| `RunnerAllocationKind` | enum | [`RunnerAllocationKind`](../../packages/d2b-contracts/src/broker_wire.rs#L1720) | `VsockCid`; `TapFdSlot`; `ApiSocketPath` |
| `BrokerCallerRole` | enum | [`BrokerCallerRole`](../../packages/d2b-contracts/src/broker_wire.rs#L1791) | `AdminUid` - struct { `uid`: `u32` }; `LauncherUid` - struct { `uid`: `u32` }; `RootUid` - struct { `uid`: `u32` }; `NotAuthorized` |
| `StorageReconcileStatus` | enum | [`StorageReconcileStatus`](../../packages/d2b-contracts/src/broker_wire.rs#L1895) | `Clean`; `Created`; `Reused`; `CheckedOnly`; `TemplateUnexpanded`; `Refused` |
| `ChildExitKind` | enum | [`ChildExitKind`](../../packages/d2b-contracts/src/broker_wire.rs#L1969) | `Exited`; `Signaled`; `Killed` |
| `BrokerNotification` | enum | [`BrokerNotification`](../../packages/d2b-contracts/src/broker_wire.rs#L2007) | `ChildReaped` - (ChildReapedNotification); `Unknown` |
