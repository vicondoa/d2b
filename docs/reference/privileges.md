...
| `QemuMediaAttach` | qemu-media hotplug | per VM / media ref | live | yes (live QMP media attach scaffold) | redacted-only | `nixling-admin` | yes | deny | `vm`, `media_ref`, `slot`, `read_only`, `qmp_commands`; no busid, by-id path, serial, or block path | [0015](../adr/0015-daemon-only-clean-break.md) |
| `QemuMediaDetach` | qemu-media hotplug | per VM / media ref | live | yes (live QMP media detach scaffold) | redacted-only | `nixling-admin` | yes | deny | `vm`, `media_ref`, `slot`, `read_only`, `qmp_commands`; no busid, by-id path, serial, or block path | [0015](../adr/0015-daemon-only-clean-break.md) |
