...
complete -c nixling -n "__fish_nixling_needs_command" -f -a "usb" -d 'USB enroll / attach / detach / probe'
...
complete -c nixling -n "__fish_nixling_using_subcommand usb; and not __fish_seen_subcommand_from attach detach enroll probe help" -s h -l help -d 'Print help'
complete -c nixling -n "__fish_nixling_using_subcommand usb; and not __fish_seen_subcommand_from attach detach enroll probe help" -f -a "attach" -d 'Bind a host USB busid to a VM via the native daemon path'
complete -c nixling -n "__fish_nixling_using_subcommand usb; and not __fish_seen_subcommand_from attach detach enroll probe help" -f -a "detach" -d 'Unbind a host USB busid from a VM via the native daemon path'
complete -c nixling -n "__fish_nixling_using_subcommand usb; and not __fish_seen_subcommand_from attach detach enroll probe help" -f -a "enroll" -d 'Enroll a physical USB disk for an opaque qemu-media ref'
complete -c nixling -n "__fish_nixling_using_subcommand usb; and not __fish_seen_subcommand_from attach detach enroll probe help" -f -a "probe" -d 'List daemon-declared USBIP claims and qemu-media USB candidates'
complete -c nixling -n "__fish_nixling_using_subcommand usb; and not __fish_seen_subcommand_from attach detach enroll probe help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c nixling -n "__fish_nixling_using_subcommand usb; and __fish_seen_subcommand_from enroll" -l busid -r
complete -c nixling -n "__fish_nixling_using_subcommand usb; and __fish_seen_subcommand_from enroll" -l dry-run
complete -c nixling -n "__fish_nixling_using_subcommand usb; and __fish_seen_subcommand_from enroll" -l apply
complete -c nixling -n "__fish_nixling_using_subcommand usb; and __fish_seen_subcommand_from enroll" -l json
complete -c nixling -n "__fish_nixling_using_subcommand usb; and __fish_seen_subcommand_from enroll" -l human
complete -c nixling -n "__fish_nixling_using_subcommand usb; and __fish_seen_subcommand_from enroll" -s h -l help -d 'Print help'
...
complete -c nixling -n "__fish_nixling_using_subcommand usb; and __fish_seen_subcommand_from help" -f -a "enroll" -d 'Enroll a physical USB disk for an opaque qemu-media ref'
...
complete -c nixling -n "__fish_nixling_using_subcommand vm; and not __fish_seen_subcommand_from start stop restart list status exec help" -s h -l help -d 'Print help'
complete -c nixling -n "__fish_nixling_using_subcommand vm; and not __fish_seen_subcommand_from start stop restart list status exec help" -f -a "start" -d 'Start the per-VM DAG (virtiofsd → CH → readiness probes)'
complete -c nixling -n "__fish_nixling_using_subcommand vm; and not __fish_seen_subcommand_from start stop restart list status exec help" -f -a "stop" -d 'Stop the per-VM DAG in reverse topo order'
complete -c nixling -n "__fish_nixling_using_subcommand vm; and not __fish_seen_subcommand_from start stop restart list status exec help" -f -a "restart" -d 'Stop then start; same envelope contract as start'
complete -c nixling -n "__fish_nixling_using_subcommand vm; and not __fish_seen_subcommand_from start stop restart list status exec help" -f -a "list" -d 'Daemon-side runtime inventory from nixlingd\'s public socket'
complete -c nixling -n "__fish_nixling_using_subcommand vm; and not __fish_seen_subcommand_from start stop restart list status exec help" -f -a "status" -d 'Daemon-side readiness state for a VM (api-ready phase)'
complete -c nixling -n "__fish_nixling_using_subcommand vm; and not __fish_seen_subcommand_from start stop restart list status exec help" -f -a "exec" -d 'Run or manage commands inside a running VM. Use `nixling vm exec <vm> -- <cmd...>` for a non-interactive command, `nixling vm exec -it <vm> -- bash` for an interactive shell, `-d` for a detached command, and `nixling vm exec <vm> {list|logs|status|kill}` to manage detached execs'
complete -c nixling -n "__fish_nixling_using_subcommand vm; and not __fish_seen_subcommand_from start stop restart list status exec help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth realm vm up down restart build generations switch boot test rollback gc store keys trust rotate-known-host migrate config help" -f -a "list" -d 'List declared VMs with daemon runtime state when nixlingd is reachable'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth realm vm up down restart build generations switch boot test rollback gc store keys trust rotate-known-host migrate config help" -f -a "status" -d 'Show per-VM runtime status plus bridge health'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth realm vm up down restart build generations switch boot test rollback gc store keys trust rotate-known-host migrate config help" -f -a "usb" -d 'USB enroll / attach / detach / probe'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth realm vm up down restart build generations switch boot test rollback gc store keys trust rotate-known-host migrate config help" -f -a "console" -d 'Foreground serial console bridge for headless VMs (not yet implemented)'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth realm vm up down restart build generations switch boot test rollback gc store keys trust rotate-known-host migrate config help" -f -a "audio" -d 'Per-VM audio grant bridge (not yet implemented)'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth realm vm up down restart build generations switch boot test rollback gc store keys trust rotate-known-host migrate config help" -f -a "audit" -d 'Tail the broker audit log'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth realm vm up down restart build generations switch boot test rollback gc store keys trust rotate-known-host migrate config help" -f -a "host" -d 'Host-side preflight, install, doctor, and reconcile verbs'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth realm vm up down restart build generations switch boot test rollback gc store keys trust rotate-known-host migrate config help" -f -a "auth" -d 'Authorisation introspection'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth realm vm up down restart build generations switch boot test rollback gc store keys trust rotate-known-host migrate config help" -f -a "realm" -d 'Low-level realm gateway helpers'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth realm vm up down restart build generations switch boot test rollback gc store keys trust rotate-known-host migrate config help" -f -a "vm" -d 'Per-VM lifecycle verbs (start / stop / restart / list / status) plus the admin-only guest-control sub-verb `exec`, which runs commands or an interactive session inside a VM over the authenticated guest-control transport (no SSH)'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth realm vm up down restart build generations switch boot test rollback gc store keys trust rotate-known-host migrate config help" -f -a "up" -d 'Alias for `vm start <vm>`'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth realm vm up down restart build generations switch boot test rollback gc store keys trust rotate-known-host migrate config help" -f -a "down" -d 'Alias for `vm stop <vm>`'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth realm vm up down restart build generations switch boot test rollback gc store keys trust rotate-known-host migrate config help" -f -a "restart" -d 'Alias for `vm restart <vm>`'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth realm vm up down restart build generations switch boot test rollback gc store keys trust rotate-known-host migrate config help" -f -a "build" -d 'Non-destructive eval + build of the per-VM toplevel'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth realm vm up down restart build generations switch boot test rollback gc store keys trust rotate-known-host migrate config help" -f -a "generations" -d 'List current / booted / numbered generations for a VM'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth realm vm up down restart build generations switch boot test rollback gc store keys trust rotate-known-host migrate config help" -f -a "switch" -d 'Atomically activate a new per-VM closure'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth realm vm up down restart build generations switch boot test rollback gc store keys trust rotate-known-host migrate config help" -f -a "boot" -d 'Stage a per-VM closure for the next boot only'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth realm vm up down restart build generations switch boot test rollback gc store keys trust rotate-known-host migrate config help" -f -a "test" -d 'Activate a per-VM closure with rollback on reboot'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth realm vm up down restart build generations switch boot test rollback gc store keys trust rotate-known-host migrate config help" -f -a "rollback" -d 'Roll a VM back to its previous generation'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth realm vm up down restart build generations switch boot test rollback gc store keys trust rotate-known-host migrate config help" -f -a "gc" -d 'Garbage-collect the per-VM /nix/store hardlink farm'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth realm vm up down restart build generations switch boot test rollback gc store keys trust rotate-known-host migrate config help" -f -a "store" -d 'Store-view maintenance and verification'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth realm vm up down restart build generations switch boot test rollback gc store keys trust rotate-known-host migrate config help" -f -a "keys" -d 'Managed-key lifecycle (list / show / rotate)'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth realm vm up down restart build generations switch boot test rollback gc store keys trust rotate-known-host migrate config help" -f -a "trust" -d 'Trust a VM\'s host key on first use (TOFU)'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth realm vm up down restart build generations switch boot test rollback gc store keys trust rotate-known-host migrate config help" -f -a "rotate-known-host" -d 'Rotate the consumer\'s recorded known-host entry for a VM'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth realm vm up down restart build generations switch boot test rollback gc store keys trust rotate-known-host migrate config help" -f -a "migrate" -d 'Analyse the host config and emit a migration plan'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth realm vm up down restart build generations switch boot test rollback gc store keys trust rotate-known-host migrate config help" -f -a "config" -d 'Sync / review / approve a VM\'s guest-editable config (`guestConfigFile`): pull the operator\'s in-VM edits to a host-side staging file, diff them, and approve them'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth realm vm up down restart build generations switch boot test rollback gc store keys trust rotate-known-host migrate config help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c nixling -n "__fish_nixling_using_subcommand help; and __fish_seen_subcommand_from usb" -f -a "enroll" -d 'Enroll a physical USB disk for an opaque qemu-media ref'
