...
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth vm up down restart build generations switch boot test rollback gc keys trust rotate-known-host migrate config help" -f -a "list" -d 'List declared VMs from the static manifest'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth vm up down restart build generations switch boot test rollback gc keys trust rotate-known-host migrate config help" -f -a "status" -d 'Show per-VM runtime status plus bridge health'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth vm up down restart build generations switch boot test rollback gc keys trust rotate-known-host migrate config help" -f -a "usb" -d 'USBIP attach / detach / probe'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth vm up down restart build generations switch boot test rollback gc keys trust rotate-known-host migrate config help" -f -a "console" -d 'Foreground serial console bridge for headless VMs (not yet implemented)'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth vm up down restart build generations switch boot test rollback gc keys trust rotate-known-host migrate config help" -f -a "audio" -d 'Per-VM audio grant bridge (not yet implemented)'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth vm up down restart build generations switch boot test rollback gc keys trust rotate-known-host migrate config help" -f -a "audit" -d 'Tail the broker audit log'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth vm up down restart build generations switch boot test rollback gc keys trust rotate-known-host migrate config help" -f -a "host" -d 'Host-side preflight, install, doctor, and reconcile verbs'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth vm up down restart build generations switch boot test rollback gc keys trust rotate-known-host migrate config help" -f -a "auth" -d 'Authorisation introspection'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth vm up down restart build generations switch boot test rollback gc keys trust rotate-known-host migrate config help" -f -a "vm" -d 'Per-VM lifecycle verbs (start / stop / restart / list / status / konsole)'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth vm up down restart build generations switch boot test rollback gc keys trust rotate-known-host migrate config help" -f -a "up" -d 'Alias for `vm start <vm>`'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth vm up down restart build generations switch boot test rollback gc keys trust rotate-known-host migrate config help" -f -a "down" -d 'Alias for `vm stop <vm>`'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth vm up down restart build generations switch boot test rollback gc keys trust rotate-known-host migrate config help" -f -a "restart" -d 'Alias for `vm restart <vm>`'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth vm up down restart build generations switch boot test rollback gc keys trust rotate-known-host migrate config help" -f -a "build" -d 'Non-destructive eval + build of the per-VM toplevel'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth vm up down restart build generations switch boot test rollback gc keys trust rotate-known-host migrate config help" -f -a "generations" -d 'List current / booted / numbered generations for a VM'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth vm up down restart build generations switch boot test rollback gc keys trust rotate-known-host migrate config help" -f -a "switch" -d 'Atomically activate a new per-VM closure'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth vm up down restart build generations switch boot test rollback gc keys trust rotate-known-host migrate config help" -f -a "boot" -d 'Stage a per-VM closure for the next boot only'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth vm up down restart build generations switch boot test rollback gc keys trust rotate-known-host migrate config help" -f -a "test" -d 'Activate a per-VM closure with rollback on reboot'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth vm up down restart build generations switch boot test rollback gc keys trust rotate-known-host migrate config help" -f -a "rollback" -d 'Roll a VM back to its previous generation'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth vm up down restart build generations switch boot test rollback gc keys trust rotate-known-host migrate config help" -f -a "gc" -d 'Garbage-collect the per-VM /nix/store hardlink farm'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth vm up down restart build generations switch boot test rollback gc keys trust rotate-known-host migrate config help" -f -a "keys" -d 'Managed-key lifecycle (list / show / rotate)'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth vm up down restart build generations switch boot test rollback gc keys trust rotate-known-host migrate config help" -f -a "trust" -d 'Trust a VM\'s host key on first use (TOFU)'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth vm up down restart build generations switch boot test rollback gc keys trust rotate-known-host migrate config help" -f -a "rotate-known-host" -d 'Rotate the consumer\'s recorded known-host entry for a VM'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth vm up down restart build generations switch boot test rollback gc keys trust rotate-known-host migrate config help" -f -a "migrate" -d 'Analyse the host config and emit a migration plan'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth vm up down restart build generations switch boot test rollback gc keys trust rotate-known-host migrate config help" -f -a "config" -d 'Sync / review / approve a VM\'s guest-editable config (`guestConfigFile`): pull the operator\'s in-VM edits to a host-side staging file, diff them, and approve them'
complete -c nixling -n "__fish_nixling_using_subcommand help; and not __fish_seen_subcommand_from list status usb console audio audit host auth vm up down restart build generations switch boot test rollback gc keys trust rotate-known-host migrate config help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
