...
| Reuse action | adapt |
| Destination | packages/d2b-provider-credential-managed-identity/src/controller.rs; packages/d2b-contracts/ |
...
| Reuse action | adapt |
| Destination | packages/d2b-provider-credential-managed-identity/src/{audit.rs,telemetry.rs}; packages/d2b-contract-tests/ |
