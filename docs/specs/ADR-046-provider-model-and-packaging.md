...
| Reuse action | adapt |
| Destination | `packages/d2b-contracts/`, `packages/d2b-provider/src/lib.rs`, `packages/d2b-provider-toolkit/` |
...
| Reuse action | create |
| Destination | `packages/d2b-contracts/{mod,audio,security_key,telemetry,usb}.rs`; generated schema artifacts for the eight exact qualified ResourceTypes |
