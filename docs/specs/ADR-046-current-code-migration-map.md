...
| `/run/d2b-heavy-gates/uid-<uid>/` | `cargo xtask heavy-gate` semaphore | SUPERSEDED | The user-approved heavy-gate removal deletes this retired validation namespace and adds no replacement scheduler or semaphore. Not a Zone resource. | |
