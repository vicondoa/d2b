...
D2B_BAZEL_TEST = $(BAZEL_BIN) test $(D2B_BAZEL_PROFILE_ARG) $(if $(strip $(D2B_BAZEL_LOCAL_TEST_JOBS)),--local_test_jobs=$(D2B_BAZEL_LOCAL_TEST_JOBS)) --test_env=D2B_REPO_ROOT="$(CURDIR)"
export D2B_BAZEL_PROFILE D2B_BAZEL_LOCAL_TEST_JOBS
