...
| [Resource mutation seal](docs/contributing/critical-subsystems.md#resource-mutation-seal) | `packages/d2b-resource-store/src/mutation_seal.rs` + `packages/d2b-resource-store-redb/src/` + `packages/d2b-resource-api/src/` | Verified resource writes consume a concrete, store-instance-bound seal by value; no generic view or unbound mutation path may return. |
