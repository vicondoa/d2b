...
partition plus integrity in 597s. Hosted success remains a merge condition.
...
limit. GitHub Actions requests one worker with a 2048 MiB limit on a 16 GiB
runner. The local hosted-shape run completed in 597s, below the 20-minute job
