...
- T604 exact-candidate coverage from an operator Nix declaration and emitted bundle through
  ...
  acceptance Volume/Network and unrelated resources; candidate-bound FR-075 continuity also
  passes through the same W5 operator record; the label is acceptance scope only and Network
  implementation remains owned by Wave 4; Guest runtime-effect acceptance remains specifically a Wave 6
...
- T220 convergence of every content change before clean exact F, followed by T600-T602
  evidence closure. Wave 5's retained request is already consumed, so T219 issues no binding
  or successor request and remains blocked until an accepted external disposition preserves
