...
- **After `adr046w5`** - US1 is complete only if T602 and T219 pass. T604 proves an operator
  can declare a Zone through Nix activation and watch resources become real through an
