...
| F002 | 2026-07-29 | `signoff` | all | Panel review commonly runs 1-2x the coding duration; strict serialization idles implementation capacity for more than half of each cycle | Motivated the pipelined-wave amendment | Mitigated by constitution 2.1.0 pipelined dispatch; not yet executable (T585-T588) |
...
- **Pipelined dispatch is not executable.** Until T585-T588 land, §4 and the `wave snapshot`
