...
| F021 | 2026-08-08 | `merge` | W5/W6 | Separate post-round-22 consistency analysis found T604 trying to pull authoritative T336-T355 work and T221 panel ownership from W6 into W5 | The feature graph could violate wave and panel ownership | Superseded by final R9: T604 retains W6 acceptance ownership, but the accepted external Network contract/work-item amendment must assign the production implementation and four-case matrix before T220. Current T336-T355 W6 placement is a fail-closed external-manifest blocker, not a post-freeze substitute |
