...
cannot construct it. A witness-consumption variant is constructible only from an exact
...
the ordered successor-proved reclamation after the targets-compacted receipt. Intent
absence then returns
