...
`Sc002IncidentIdV1` preimages, and persisted status `incidentKind` before T589 dispatch.
...
ordered before/after identities. T220 verifies all four vectors and one-to-one
payload-or-locator/status/id kind agreement before F may freeze.
