...
- Installed-host migration is whole-generation only. No activation may expose a 4/2 daemon
  ...
  refuse. The systemd-supervised existing daemon DAG is the durable rollback-resume owner
