...
#
# Usage:
#   modules/nixling/tests/nixling-store.sh                 # full run
#   modules/nixling/tests/nixling-store.sh --quick         # smoke subset
#   modules/nixling/tests/nixling-store.sh --only test_X   # one test
#
