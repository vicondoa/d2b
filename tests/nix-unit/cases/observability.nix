...
#
# The retired bash gate imported tests/eval-cases/observability.nix and then
...
# `config.assertions`, matching tests/nix-unit/cases/assertions.nix.
#
# Spec corrections ("existing code is canon"):
#   * tests/eval-cases/observability.nix still re-gets the flake through
