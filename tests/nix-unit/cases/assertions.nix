...
# (tests/eval-cases/assertions.nix) and the minimal `lib.evalModules`
# evaluator (tests/eval-cases/shared.nix, ~0.6 s/case — NOT a full
...
#     tests/eval-cases/assertions.nix for traceability. These three cases
