#!/usr/bin/env bash
# tests/live-vm-smoke.sh— v1.2 live-VM smoke gate.
#
...
# ---------------------------------------------------------------------------
log "==> tests/live-vm-smoke.sh (mode: $MODE)"
...
LOG_FILE="$ROOT/tests/smoke-run-log.txt"
...
# ---------------------------------------------------------------------------
# Append result to smoke-run-log.txt
# ---------------------------------------------------------------------------
if [ "$FAIL" -eq 0 ]; then
  STATUS=PASS
else
