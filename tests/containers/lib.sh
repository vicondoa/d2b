#!/usr/bin/env bash
# tests/containers/lib.sh — shared helpers for the podman-based integration
# test layer (the type-G container tests).
#
# Design: each test is a standalone bash script in tests/containers/ that
...
# one. See tests/containers/README.md.
#
...
# tests/rust-workspace-checks.sh.
