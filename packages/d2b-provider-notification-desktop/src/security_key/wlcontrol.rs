...
//! (see [`crate::security_key::nonce`]).  When the user triggers an action, wlcontrol MUST
...
use crate::security_key::state::{CeremonySummary, SkNotifyState};
...
pub struct WlcontrolAction {
    ...
    /// [`crate::security_key::nonce::action_key_for`].
...
mod tests {
    use super::*;
    use crate::security_key::events::SecurityKeyEvent;
    use crate::security_key::state::SkNotifyState;
