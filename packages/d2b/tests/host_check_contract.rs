...
//!     `d2b_contracts_control::cli_output::HostCheckOutputV2` (the `deny_unknown_fields` DTOs make this
...
use d2b_contracts_control::cli_output::{HostCheckOutputV2, HostCheckSeverityV2};
