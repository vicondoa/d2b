...
/// Spec format magic ("D2ES" = d2b Exec Spec) + version.
const SPEC_MAGIC: u32 = 0x4432_4553;
...
mod tests {
    ...
    fn sample() -> ExecSpec {
        ExecSpec {
            ...
            workload_unit_name: "d2b-exec-07-w.service".to_owned(),
            systemd_run_args: vec![
                "--uid=alice".to_owned(),
                "--unit=d2b-exec-07-w.service".to_owned(),
