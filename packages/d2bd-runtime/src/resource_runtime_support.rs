...
use d2b_contracts_resource::v3::{
    PolicySnapshot, StoreListResult, StoreProjection, StoredResource,
};
use d2b_session::{
...
pub async fn register_system_core_session(
    ...
    api: Arc<ResourceService<ZoneApiBackend>>,
...
/// store that once stood beside it is deleted).
pub type ZoneApiBackend = d2b_resource_api::manager_backend::ManagerBackend;
