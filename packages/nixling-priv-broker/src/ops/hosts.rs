...
use nixling_core::bundle_resolver::ResolvedHostsIntent;
use nixling_core::host_w3::HostsEntry;
use nixling_host::routes::{extract_managed_block, render_hosts_block};
use std::io;
...
mod tests {
    ...
    fn write_marker_block_preserves_foreign_lines_in_executor_payload() {
        ...
        let intent = ResolvedHostsIntent {
            ...
            managed_block: "# nixling-managed begin\n10.0.0.3 new\n# nixling-managed end\n"
                .to_owned(),
            mode: 0o644,
        };
