...
/// Guard against the thread::park() scaffold pattern in d2b-cli../src/bin/d2b-clipd.rs.
///
...
fn clipd_is_not_a_thread_park_scaffold() {
    let main_src = include_str!("../src/bin/d2b-clipd.rs");
    assert!(
        !main_src.contains("thread::park()"),
        "d2b-cli../src/bin/d2b-clipd.rs uses thread::park() - this is a scaffold placeholder. \
