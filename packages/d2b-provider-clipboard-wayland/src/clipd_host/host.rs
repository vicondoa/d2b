...
impl<P: crate::clipd_host::niri::FocusedWindowProvider> HostClipboard<P> {
    ...
    pub fn apply_niri_cache_event(
        &mut self,
        event: crate::clipd_host::niri::NiriEvent,
...
mod tests {
    use super::*;
    use crate::clipd_host::niri::{FocusedWindowProvider, NiriIpcError, NiriWindow};
