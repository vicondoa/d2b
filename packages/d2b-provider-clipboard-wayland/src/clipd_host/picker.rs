...
use crate::clipd_host::framing::{FramingError, decode_frame};
use crate::clipd_host::policy::ReasonCode;
use crate::clipd_host::protocol::PickerToDaemonMessage;
use thiserror::Error;
...
pub enum PickerError {
    ...
    #[cfg_attr(not(test), expect(dead_code, reason = "test-only environment assertion"))]
