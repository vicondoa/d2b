...
fn handle_bridge_paste_request(
    ...
    if !is_mime_allowed(&mime_type) {
        ...
        if let Err(reason) = context.audit_queue.enqueue_fail_closed(AuditEvent {
            ...
            attribution: crate::clipd_host::policy::AttributionQuality::ExactClient,
...
fn insert_live_host_candidate(
    ...
    attribution: crate::clipd_host::policy::AttributionQuality,
    requested_mime_type: &str,
) {
    candidates.retain(|candidate| candidate.entry_id != CURRENT_HOST_ENTRY_ID);
    candidates.insert(
...
fn protocol_attribution(quality: crate::clipd_host::policy::AttributionQuality) -> AttributionQuality {
    match quality {
        ...
        crate::clipd_host::policy::AttributionQuality::CacheStaleFocusedWindowGuess => {
            AttributionQuality::CacheStaleFocusedWindowGuess
        }
        crate::clipd_host::policy::AttributionQuality::BrokerInjectedDebug => {
...
impl crate::clipd_host::niri::FocusedWindowProvider for NiriQueryProvider {
    fn query_focused_window(
        &mut self,
    ) -> Result<Option<crate::clipd_host::niri::NiriWindow>, NiriIpcError> {
...
mod tests {
    use super::*;
    use crate::clipd_host::notifications::RecordingNotifier;
