...
pub use d2b_contracts_zone_session::v3::GuestSpec;
pub use d2b_contracts_zone_session::v3::execution_policy::{DeviceAttachment, NetworkAttachment};
...
pub fn build_guest_resource_spec(
    ...
    let provider = ProviderSpecExtension::new(
        d2b_contracts_zone_session::v3::ExtensionSchemaId::parse(GUEST_SPEC_SCHEMA_ID)
