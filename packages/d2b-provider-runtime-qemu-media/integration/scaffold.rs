...
pub fn fixture() -> (
    ...
    let guest_ref = d2b_contracts_zone_session::v3::ResourceRef::parse("Guest/media-vm")
        .expect("fixture Guest ref");
    let volume_ref = d2b_contracts_zone_session::v3::ResourceRef::parse("Volume/runtime")
        .expect("fixture Volume ref");
    let guest = build_guest_resource_spec(
        Some(
            d2b_contracts_zone_session::v3::ResourceRef::parse("Volume/boot")
                .expect("fixture Volume ref"),
        ),
        2,
        4096,
    ...
    let process = build_process_spec(
        d2b_contracts_zone_session::v3::ResourceRef::parse("Host/host-system")
            .expect("fixture Host ref"),
        volume_ref,
        Some(
            d2b_contracts_zone_session::v3::ResourceRef::parse("Device/host-kvm")
