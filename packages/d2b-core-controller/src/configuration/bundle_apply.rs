...
use d2b_contracts_zone_session::v3::{
    ...
    {ConfigurationGeneration, Timestamp},
};
...
pub struct DesiredBundleResource {
    ...
    spec: d2b_contracts_zone_session::v3::CanonicalJsonObject,
}
...
impl DesiredBundleResource {
    ...
    pub const fn spec(&self) -> &d2b_contracts_zone_session::v3::CanonicalJsonObject {
        &self.spec
    }
}
...
pub enum BundleApplyEffect {
    ...
    PrunePriorBundle(d2b_contracts_zone_session::v3::ResourceBundleGenerationId),
