...
fn seed_batch_with(operation_id: &str, name: &str) -> GuestLocalSeedBatch {
    ...
    GuestLocalSeedBatch::new(
        ...
        operation_id,
        vec![
            d2b_provider_guest_cloud_hypervisor::GuestLocalSeedResource::new(
...
#[async_trait]
impl d2b_provider_guest_cloud_hypervisor::GuestControlEndpointResolver for FakeResolver {
...
#[async_trait]
impl d2b_provider_guest_cloud_hypervisor::GuestControlSessionConnector for FakeConnector {
...
#[async_trait]
impl d2b_provider_guest_cloud_hypervisor::GuestControlSessionConnector for SequenceConnector {
    type Session = FakeSession;
...
#[async_trait]
impl d2b_provider_guest_cloud_hypervisor::GuestControlSessionConnector for LossConnector {
...
async fn valid_endpoint_session_and_seed_reach_ready() {
    ...
    let mut controller = d2b_provider_guest_cloud_hypervisor::GuestLocalController::new(
        expectation(),
        resolver,
        connector,
    );
