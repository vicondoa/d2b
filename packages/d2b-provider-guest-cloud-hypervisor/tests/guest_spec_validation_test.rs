...
fn commit_response_maps_every_child_and_fences_bad_rows() {
    ...
    assert_eq!(
        ...
        Err(d2b_provider_guest_cloud_hypervisor::CommitResponseError::WrongOwner)
    );
    ...
    assert_eq!(
        ...
        Err(d2b_provider_guest_cloud_hypervisor::CommitResponseError::WrongZone)
    );
    ...
    let mut wrong_type = batch
        ...
        .collect::<Vec<_>>();
    wrong_type[0] = d2b_provider_guest_cloud_hypervisor::CommittedChild::new(
    ...
    assert_eq!(
        ...
        Err(d2b_provider_guest_cloud_hypervisor::CommitResponseError::WrongType)
    );
}
