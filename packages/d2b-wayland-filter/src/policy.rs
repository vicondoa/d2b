...
//! priority:
//!
//! 1. Required-baseline rules: core globals that d2b needs for graphics.
...
mod tests {
    ...
    fn app_id_already_prefixed_passes_through() {
        let p = policy_for("work");
        let already = "d2b.work.org.mozilla.firefox";
    ...
    fn app_id_cross_vm_spoof_gets_double_prefix() {
        ...
        assert_eq!(
            ...
            "d2b.work.d2b.personal.org.example.app"
        );
    }
