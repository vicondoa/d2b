...
pub fn canonical_export_id(value: &str) -> String {
    if d2b_contracts_zone_session::v3::is_canonical_digest(value) {
        ...
        d2b_contracts_zone_session::v3::canonical_digest(TRACE_CONTEXT_DIGEST_DOMAIN, value.as_bytes())
    }
}
...
mod tests {
    ...
    fn exported_ids_share_one_canonical_digest_domain() {
        ...
        assert_eq!(
            ...
            d2b_contracts_zone_session::v3::canonical_digest(TRACE_CONTEXT_DIGEST_DOMAIN, b"trace")
        );
        assert_eq!(
            context.exported_span_id(),
            d2b_contracts_zone_session::v3::canonical_digest(TRACE_CONTEXT_DIGEST_DOMAIN, b"span")
        );
    }
}
