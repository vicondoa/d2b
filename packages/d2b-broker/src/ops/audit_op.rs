...
//! `0640 root:d2bd` log goes via [`crate::audit::AuditLog`]; this
...
use d2b_contracts_resource::v3::{ResourceBundleGenerationId, ResourceGeneration};
...
pub enum OperationFields {
    ...
    /// ensures `/var/lib/d2b/dnsmasq/<vm>.leases` exists with the
...
mod tests {
    ...
    roundtrip_test!(
        ...
        OperationFields::ApplySysctl {
            ...
            key: "net.ipv6.conf.d2b-work.disable_ipv6".to_owned(),
            destroy: false,
        }
    );
    roundtrip_test!(
