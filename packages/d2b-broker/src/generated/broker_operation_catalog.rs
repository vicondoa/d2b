...
pub const BROKER_OPERATION_CATALOG: &[BrokerOperationRow] = &[
    ...
    BrokerOperationRow {
        ...
        payload_provenance: PayloadProvenance::Request,
        payload_fields: &["activationInput", "argv", "binaryPath", "capabilities", "cgroupPlacement", "deviceWorker", "env", "gid", "mountPolicy", "namespaces", "rootCarveOut", "seccompPolicyRef", "skipBinaryExistsCheck", "supplementaryGroups", "swtpmIdentity", "uid", "umask", "userNamespace"],
        payload_required: &["binaryPath", "argv", "uid", "gid", "supplementaryGroups", "env", "capabilities", "namespaces", "mountPolicy", "cgroupPlacement"],
        audit_join: None,
        max_fds: 8,
        fd_kind: Some(FdKind::Any),
        state_cell: None,
