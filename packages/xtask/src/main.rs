...
use nixling_constellation_core::{
    ...
    ShellAttachRequest, ShellAttachSummary, ShellCause, ShellDetachRequest, ShellGeneration,
    ShellKillRequest, ShellListRequest, ShellListResponse, ShellName, ShellSessionInstanceId,
    ShellState, ShellSummary, StreamCursor, StreamId, StreamResume, WorkloadId, WorkloadSelector,
    WorkloadSummary,
    audit::{
