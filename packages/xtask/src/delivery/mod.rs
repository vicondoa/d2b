...
pub use model::{
    ...
    Fingerprint, GitObjectFormat, PANEL_CURRENT_ROLES, PANEL_MODEL_POLICY, PANEL_PROVIDER_POLICY,
    PANEL_REASONING_EFFORT_POLICY, PANEL_ROLES, PanelRole, PanelSelectionV1, RepositoryRecord,
    SnapshotSha256, canonical_digest,
};
