...
pub struct AuthenticatedSubjectContext {
    subject_ref: crate::v3::ResourceRef,
    subject_uid: ResourceUid,
    zone_ref: crate::v3::ResourceRef,
    evidence_class: EvidenceClass,
    execution_ref: Option<crate::v3::ResourceRef>,
    provider_ref: Option<crate::v3::ResourceRef>,
    process_ref: Option<crate::v3::ResourceRef>,
...
impl AuthenticatedSubjectContext {
    ...
    pub fn with_execution_ref(mut self, value: crate::v3::ResourceRef) -> Self {
        self.execution_ref = Some(value);
        self
    }

    /// Bind the Provider resource established by trusted evidence.
    pub fn with_provider_ref(mut self, value: crate::v3::ResourceRef) -> Self {
        self.provider_ref = Some(value);
        self
    }

    /// Bind the Process resource established by trusted evidence.
    pub fn with_process_ref(mut self, value: crate::v3::ResourceRef) -> Self {
    ...
    pub fn subject_ref(&self) -> &crate::v3::ResourceRef {
        &self.subject_ref
    }
    ...
    pub fn zone_ref(&self) -> &crate::v3::ResourceRef {
        &self.zone_ref
    }
    ...
    pub fn execution_ref(&self) -> Option<&crate::v3::ResourceRef> {
        self.execution_ref.as_ref()
    }

    /// Borrow the optional Provider reference.
    pub fn provider_ref(&self) -> Option<&crate::v3::ResourceRef> {
        self.provider_ref.as_ref()
    }

    /// Borrow the optional Process reference.
    pub fn process_ref(&self) -> Option<&crate::v3::ResourceRef> {
