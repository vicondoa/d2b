...
fn fixtures_dir() -> PathBuf {
    let fixtures = env::var_os("D2B_FIXTURES")
        .unwrap_or_else(|| panic!("D2B_FIXTURES must point to the fixture-smoke output directory"));
...
/// artifacts (D2B_FIXTURES_FULL), or `None` when that fixture is unavailable
