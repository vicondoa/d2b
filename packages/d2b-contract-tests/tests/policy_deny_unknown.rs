...
//! the real `d2b-core` host-schema sources and asserts every
...
//! repo-file access via the `d2b_contract_tests` helpers is sound here.
//!
//! Migrated gates:
...
//
// Every security-sensitive DTO under `d2b-core::host_w3` (plus the
...
fn host_schema_dtos_carry_deny_unknown_fields() {
    let host_w3_rel = "packages/d2b-core/src/host_w3.rs";
    let host_rel = "packages/d2b-core/src/host.rs";
