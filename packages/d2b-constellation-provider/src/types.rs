...
pub use d2b_constellation_core::{StreamKind, StreamOpen};
...
pub struct PersistentShellStatus {
    ...
    pub summary: d2b_constellation_core::ShellSummary,
}
...
mod tests {
    ...
    fn shell_generation() -> ShellGeneration {
        ShellGeneration {
            guest_boot_id: d2b_constellation_core::ProtocolToken::parse("boot-a").unwrap(),
            guestd_instance_id: d2b_constellation_core::ProtocolToken::parse("guestd-a").unwrap(),
            shell_daemon_instance_id: d2b_constellation_core::ProtocolToken::parse("shell-a")
                .unwrap(),
        }
    }
