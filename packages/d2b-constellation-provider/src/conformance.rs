        ...
        let req = PersistentShellAttachProviderRequest {
            ...
            request: ShellAttachRequest {
                ...
                generation: ShellGeneration {
                    guest_boot_id: d2b_constellation_core::ProtocolToken::parse("boot-1").unwrap(),
                    guestd_instance_id: d2b_constellation_core::ProtocolToken::parse("guestd-1")
                        .unwrap(),
                    shell_daemon_instance_id: d2b_constellation_core::ProtocolToken::parse(
                        "shell-daemon-1",
                    )
                    .unwrap(),
                },
