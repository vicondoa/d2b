...
use d2b_contracts_zone_session::v3::host::IsolationPosture;
...
fn a_user_domain_host_must_name_the_exact_user_it_resolves() {
    ...
    use d2b_contracts_zone_session::v3::execution_policy::{BudgetSpec, ExecutionPolicy, PrimitiveSpecError};
    ...
    let spec = d2b_contracts_zone_session::v3::host::HostSpec::new(policy, None)
