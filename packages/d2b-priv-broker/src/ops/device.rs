...
pub fn live_open_kvm(
    ...
    req: &d2b_contracts_broker::broker_wire::OpenKvmRequest,
...
pub fn live_open_vhost_net(
    _exec: &SystemLiveExec,
    resolver: &BundleResolver,
    req: &d2b_contracts_broker::broker_wire::OpenVhostNetRequest,
    _audit_log: &crate::audit::AuditLog,
) -> Result<LiveOpenDeviceOutcome, super::OpError> {
...
pub fn live_open_fuse(
    _exec: &SystemLiveExec,
    resolver: &BundleResolver,
    req: &d2b_contracts_broker::broker_wire::OpenFuseRequest,
    _audit_log: &crate::audit::AuditLog,
) -> Result<LiveOpenDeviceOutcome, super::OpError> {
...
pub fn live_open_device(
    _exec: &SystemLiveExec,
    resolver: &BundleResolver,
    req: &d2b_contracts_broker::broker_wire::OpenDeviceRequest,
    _audit_log: &crate::audit::AuditLog,
) -> Result<LiveOpenDeviceOutcome, super::OpError> {
