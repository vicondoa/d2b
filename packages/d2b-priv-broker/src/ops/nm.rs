...
pub fn render_nm_conf(entries: &[NmUnmanagedEntry]) -> String {
    ...
    out.push_str("# Generated by d2b-priv-broker; do not edit by hand.\n");
...
mod tests {
    ...
    fn entry(ifn_str: &str) -> NmUnmanagedEntry {
        NmUnmanagedEntry {
            if_name: d2b_contracts_zone_session::v3::IfName::new(ifn_str).unwrap(),
    ...
    fn render_conf_lists_interfaces() {
        ...
        assert!(body.contains(&format!("interface-name:{}", d2b_link.as_str())));
        assert!(body.contains("# d2b-managed begin"));
        assert!(body.contains("# d2b-managed end"));
    }
    ...
    fn managed_foreign_conflict_detected() {
        let e = entry("d2b-b-x");
        let err = verify_all_unmanaged(&[e], "d2b-b-x:connected\n").unwrap_err();
    ...
    fn apply_with_reload_writes_resolved_contents_and_reloads_nm() {
        ...
        let intent = ResolvedNmUnmanagedIntent {
            ...
            contents: "# d2b-managed begin\n[keyfile]\nunmanaged-devices=interface-name:d2b-b-x\n# d2b-managed end\n".to_owned(),
            mode: 0o644,
            owner: "root".to_owned(),
            group: "root".to_owned(),
