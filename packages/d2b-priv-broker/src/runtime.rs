        ...
        RealBrokerRequest::SpawnRunner(req) => {
            ...
            match d2b_host::runner_argv_regenerator::regenerate_argv(intent, &regenerator_extra) {
                ...
                Err(
                    ...
                    // Provider-owned device generators are intentionally not
                    // invoked by this cross-role host regenerator. Until
                    // typed generator inputs are carried in the trusted
