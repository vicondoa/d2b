...
//! daily timer to catch malformed records and `d2b host doctor`
//! can poll cheaply.
//!
//! [broker]: https://github.com/vicondoa/d2b/blob/main/packages/d2b-priv-broker/src/ops/audit_op.rs
//!
...
pub const DEFAULT_AUDIT_DIR: &str = "/var/lib/d2b/audit";
...
/// `d2b_priv_broker::ops::audit_op::OpAuditRecord`.
...
///   `defects` array tells operators (and `d2b host doctor`)
///   what action to take.
