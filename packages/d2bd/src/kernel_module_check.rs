...
//!
//! Every VM d2b spawns relies on a small, predictable set of
...
//! [`d2b_host::modules`] probe surface) are treated as
//! present.
//!
//! # Scope
//!
...
/// Required modules every d2b VM needs, regardless of opt-in
...
/// the host probe (see [`d2b_host::modules`]). A module that
...
mod tests {
    ...
    /// occasionally-resnaped) [`d2b_core::processes::RoleProfile`]
    /// struct.
