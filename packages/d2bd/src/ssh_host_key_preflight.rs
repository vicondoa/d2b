...
//! # Canonical posture
//!
//! Directory `/var/lib/d2b/vms/<vm>/sshd-host-keys/`:
//! - mode `0750`
//! - owner `d2bd`, group `d2b`
...
//! `/var/lib/d2b/keys/<vm>/sshd-host-keys` and a
//! `root:d2b-<vm>-runner 0750` directory posture with `0640`
...
//! `/var/lib/d2b/vms/<vm>/sshd-host-keys` and `0750` for the
...
mod tests {
    ...
    fn drift_path_accessor_returns_offending_path() {
        let p = PathBuf::from("/var/lib/d2b/vms/vm1/sshd-host-keys/ssh_host_ed25519_key");
