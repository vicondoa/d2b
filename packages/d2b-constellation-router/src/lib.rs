//! `d2b-constellation-router` (ADR 0032): the **codec-neutral**
...
//!
//! Dependency direction: depends ONLY on `d2b-constellation-core` +
//! `d2b-constellation-provider`. It MUST NOT depend on `prost`, a codec
...
mod tests {
    use super::*;
    use d2b_constellation_core::{NodeId, OpaquePayload, OperationId, OperationKind, RealmPath};
