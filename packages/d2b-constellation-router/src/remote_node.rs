...
pub enum RemotePeerStatus {
    ...
    Completed(d2b_constellation_core::OpaquePayload),
...
pub trait RemotePeerClient: Send {
    ...
    fn send_operation(
        ...
        route: &RemoteRoute,
        req: &OperationRequest,
    ) -> Result<d2b_constellation_core::OpaquePayload, RemoteNodeError>;
...
pub enum RemoteDispatchOutcome {
    ...
    Sent {
        route: RemoteRoute,
        result: d2b_constellation_core::OpaquePayload,
    },
...
mod tests {
    use super::*;
    use d2b_constellation_core::{IdempotencyKey, OpaquePayload, OperationId, WorkloadId};
