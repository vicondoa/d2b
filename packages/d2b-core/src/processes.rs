...
// Known role types in the ADR 0004 process graph, generated from the
// process family's `resource-types.json` declaration (U4).
include!("generated/process_roles.rs");
