...
/// not fake Cloud Hypervisor, component-session, or in-guest observability values.
...
mod tests {
    ...
    fn unknown_reserved_keys_fail_closed() {
        let error = ManifestV04::from_slice(
            br#"{"_manifest":{"manifestVersion":6},"_observability":{"enabled":false,"vmName":"sys-obs","obsVsockCid":1000,"obsVsockHostSocket":"/var/lib/d2b/vms/sys-obs/vsock.sock","signozUrl":"http://10.40.0.10:8080","signozOtlpGrpcPort":4317,"signozOtlpHttpPort":4318},"_future":{}}"#,
        )
    ...
    fn obsolete_manifest_version_is_rejected() {
        let error = ManifestV04::from_slice(
            br#"{"_manifest":{"manifestVersion":5},"_observability":{"enabled":false,"vmName":"sys-obs","obsVsockCid":1000,"obsVsockHostSocket":"/var/lib/d2b/vms/sys-obs/vsock.sock","signozUrl":"http://10.40.0.10:8080","signozOtlpGrpcPort":4317,"signozOtlpHttpPort":4318}}"#,
        )
    ...
    fn v6_manifest_version_loads_with_default_lifecycle() {
        let manifest = ManifestV04::from_slice(
            br#"{"_manifest":{"manifestVersion":6},"_observability":{"enabled":false,"vmName":"sys-obs","obsVsockCid":1000,"obsVsockHostSocket":"/var/lib/d2b/vms/sys-obs/vsock.sock","signozUrl":"http://10.40.0.10:8080","signozOtlpGrpcPort":4317,"signozOtlpHttpPort":4318},"corp-vm":{"apiSocket":"/var/lib/d2b/vms/corp-vm/corp-vm.sock","audio":false,"audioService":"d2b-corp-vm-snd.service","audioStateFile":"/var/lib/d2b/vms/corp-vm/state/audio-state.json","bridge":"br-work-lan","env":"work","gpuSocket":"/var/lib/d2b/vms/corp-vm/corp-vm-gpu.sock","graphics":false,"isNetVm":false,"name":"corp-vm","netVm":"sys-work-net","observability":{"agentSocket":"/run/d2b/otlp.sock","enabled":false,"vsockCid":110,"vsockHostSocket":"/var/lib/d2b/vms/corp-vm/vsock.sock"},"runtime":{"kind":"nixos","provider":{"id":"local-cloud-hypervisor","type":"local","driver":"cloud-hypervisor"},"capabilities":{"lifecycle":true,"display":true,"usbHotplug":true,"exec":true,"configSync":true,"ssh":true,"storeSync":true,"keys":true,"inGuestObservability":true}},"sshUser":"alice","stateDir":"/var/lib/d2b/vms/corp-vm","staticIp":"10.20.0.10","tap":"work-l10","tpm":false,"tpmSocket":"/run/d2b/vms/corp-vm/tpm.sock","usbipYubikey":false,"usbipdHostIp":"192.0.2.1"}}"#,
        )
    ...
    fn current_manifest_version_loads() {
        let manifest = ManifestV04::from_slice(
            br#"{"_manifest":{"manifestVersion":7},"_observability":{"enabled":false,"vmName":"sys-obs","obsVsockCid":1000,"obsVsockHostSocket":"/var/lib/d2b/vms/sys-obs/vsock.sock","signozUrl":"http://10.40.0.10:8080","signozOtlpGrpcPort":4317,"signozOtlpHttpPort":4318}}"#,
        )
    ...
    fn future_manifest_version_is_rejected() {
        let error = ManifestV04::from_slice(
            br#"{"_manifest":{"manifestVersion":99},"_observability":{"enabled":false,"vmName":"sys-obs","obsVsockCid":1000,"obsVsockHostSocket":"/var/lib/d2b/vms/sys-obs/vsock.sock","signozUrl":"http://10.40.0.10:8080","signozOtlpGrpcPort":4317,"signozOtlpHttpPort":4318}}"#,
        )
    ...
    fn shell_default_name_shape_is_validated() {
        let error = ManifestV04::from_slice(
            br#"{"_manifest":{"manifestVersion":6},"_observability":{"enabled":false,"vmName":"sys-obs","obsVsockCid":1000,"obsVsockHostSocket":"/var/lib/d2b/vms/sys-obs/vsock.sock","signozUrl":"http://10.40.0.10:8080","signozOtlpGrpcPort":4317,"signozOtlpHttpPort":4318},"corp-vm":{"apiSocket":"/var/lib/d2b/vms/corp-vm/corp-vm.sock","audio":false,"audioService":"d2b-corp-vm-snd.service","audioStateFile":"/var/lib/d2b/vms/corp-vm/state/audio-state.json","bridge":"br-work-lan","env":"work","gpuSocket":"/var/lib/d2b/vms/corp-vm/corp-vm-gpu.sock","graphics":false,"isNetVm":false,"name":"corp-vm","netVm":"sys-work-net","observability":{"agentSocket":"/run/d2b/otlp.sock","enabled":false,"vsockCid":110,"vsockHostSocket":"/var/lib/d2b/vms/corp-vm/vsock.sock"},"runtime":{"kind":"nixos","provider":{"id":"local-cloud-hypervisor","type":"local","driver":"cloud-hypervisor"},"capabilities":{"lifecycle":true,"display":true,"usbHotplug":true,"exec":true,"configSync":true,"ssh":true,"storeSync":true,"keys":true,"inGuestObservability":true}},"shell":{"defaultName":"bad/name","enabled":true,"maxAttached":1,"maxSessions":8},"sshUser":"alice","stateDir":"/var/lib/d2b/vms/corp-vm","staticIp":"10.20.0.10","tap":"work-l10","tpm":false,"tpmSocket":"/run/swtpm/corp-vm/sock","usbipYubikey":false,"usbipdHostIp":"192.0.2.1"}}"#,
        )
