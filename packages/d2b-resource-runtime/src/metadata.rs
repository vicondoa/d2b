...
/// The resource verbs every declaration-only metadata type supports.
///
...
/// verbs, and the rules and the typed CLI nouns resolve their gating from
/// this declaration.
pub const METADATA_VERBS: &[&str] = &[
    "get",
    "list",
    "watch",
    "create",
