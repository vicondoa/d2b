...
mod tests {
    ...
    fn transcript_golden_vectors_are_stable() {
        ...
        assert_eq!(
            ...
            [
                93, 199, 74, 209, 53, 46, 141, 173, 144, 132, 216, 49, 182, 159, 211, 240, 147, 10,
                245, 238, 186, 122, 107, 97, 196, 179, 85, 251, 93, 138, 35, 166,
            ]
        );
        assert_eq!(
            token.sign_tag(&guest).unwrap(),
            [
                148, 56, 197, 241, 240, 120, 35, 254, 191, 219, 184, 147, 202, 170, 75, 3, 140,
                124, 232, 135, 165, 122, 255, 249, 113, 14, 252, 167, 25, 75, 68, 7,
            ]
        );
    }
