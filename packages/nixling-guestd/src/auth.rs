...
mod tests {
    ...
    fn transcript_golden_vectors_are_stable() {
        ...
        assert_eq!(
            ...
            [
                115, 241, 228, 251, 188, 154, 61, 55, 186, 214, 178, 88, 26, 115, 253, 136, 237,
                127, 148, 39, 159, 106, 62, 74, 208, 85, 205, 6, 207, 235, 140, 153,
            ]
        );
        assert_eq!(
            token.sign_tag(&guest).unwrap(),
            [
                91, 43, 197, 225, 112, 39, 0, 93, 202, 102, 18, 58, 44, 12, 186, 255, 165, 108, 13,
                195, 46, 233, 96, 199, 252, 150, 139, 13, 62, 200, 65, 142,
            ]
        );
    }
