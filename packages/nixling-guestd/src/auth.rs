...
mod tests {
    ...
    fn transcript_golden_vectors_are_stable() {
        ...
        assert_eq!(
            ...
            [
                35, 65, 198, 144, 19, 46, 24, 23, 212, 229, 67, 216, 188, 115, 165, 67, 85, 125,
                158, 131, 192, 79, 106, 70, 62, 184, 244, 236, 134, 37, 12, 83,
            ]
        );
        assert_eq!(
            token.sign_tag(&guest).unwrap(),
            [
                133, 84, 156, 150, 41, 237, 172, 236, 40, 116, 86, 180, 232, 181, 198, 59, 63, 129,
                5, 82, 163, 251, 176, 235, 252, 79, 97, 108, 208, 206, 122, 88,
            ]
        );
    }
