...
mod tests {
    ...
    fn transcript_golden_vectors_are_stable() {
        ...
        assert_eq!(
            ...
            [
                87, 24, 183, 106, 36, 247, 165, 115, 90, 28, 189, 123, 47, 150, 236, 245, 80, 227,
                105, 160, 227, 123, 101, 195, 28, 78, 156, 110, 52, 108, 130, 88,
            ]
        );
        assert_eq!(
            token.sign_tag(&guest).unwrap(),
            [
                240, 24, 98, 222, 35, 187, 177, 25, 120, 120, 81, 210, 46, 37, 166, 132, 20, 83,
                29, 217, 170, 54, 198, 38, 96, 183, 160, 92, 142, 47, 134, 123,
            ]
        );
    }
