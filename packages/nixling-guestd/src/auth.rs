...
mod tests {
    ...
    fn transcript_golden_vectors_are_stable() {
        ...
        assert_eq!(
            ...
            [
                105, 150, 134, 70, 148, 25, 51, 220, 99, 182, 67, 109, 252, 204, 247, 167, 19, 137,
                245, 96, 216, 111, 100, 19, 197, 97, 67, 89, 182, 200, 103, 131,
            ]
        );
        assert_eq!(
            token.sign_tag(&guest).unwrap(),
            [
                192, 49, 87, 16, 127, 11, 162, 167, 246, 244, 51, 46, 165, 129, 175, 57, 148, 196,
                60, 181, 78, 197, 40, 10, 147, 106, 156, 123, 8, 160, 211, 21,
            ]
        );
    }
