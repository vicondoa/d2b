...
mod tests {
    ...
    fn redaction_preserves_semantic_tokens_and_is_idempotent() {
        let raw = br#"{"signal":"trace","value":{"event":"accepted","outcome":"ok","service":"store","transport":"unix","profile":"NN","kind":"single","direction":"local","record_class":"process-effect","operation":"scan","op":"EnvelopeInvoke","path":"/secret/path"}}"#;
