...
mod tests {
    ...
    use super::{
        ...
        UsbipComponent, UsbipDriverArgs, UsbipDriverEffects, usbip_descriptors,
    };

    #[derive(Default)]
    struct RecordingEffects {
        reconciled: parking_lot::Mutex<Vec<UsbipComponent>>,
        finalized: parking_lot::Mutex<Vec<UsbipComponent>>,
    }
