...
use d2b_gateway::{GatewayAudit, GatewayAuditEvent, GatewayError};
...
mod tests {
    ...
    fn event(kind: GatewayAuditKind, op: &str) -> GatewayAuditEvent {
        GatewayAuditEvent {
            ...
            session_id: Some(d2b_gateway::DisplaySessionId::new("s1")),
    ...
    #[test]
    fn jsod2b_records_hash_chain_and_redacts_payloads() {
