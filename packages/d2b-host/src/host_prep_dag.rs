...
pub enum HostPrepStepKind {
    ...
    /// runner intent (graphics VMs need the `d2b-<vm>-gpu` uid,
    /// not `microvm`).
    BringUpTapInterface,
...
pub fn build_host_prep_dag_for_runtime(
    ...
    // 00-d2b-unmanaged.conf materializer leaf of microvm-setup.
    steps.push(HostPrepStep {
