...
pub mod constants {
    ...
    //! `#![forbid(unsafe_code)]` invariant on `d2b-host` holds and
...
pub fn negative_matrix() -> Vec<NegativeMatrixCase> {
    vec![
        ...
        NegativeMatrixCase {
            ...
            expected_allowed: true,
            rationale: "Broker chowns delegated d2b.slice subtree only.".to_owned(),
        },
        NegativeMatrixCase {
            class: NegativeMatrixClass::CgroupChown,
        ...
        NegativeMatrixCase {
            ...
            name: "declared inet d2b apply allowed".to_owned(),
            expected_allowed: true,
            rationale: "Batch confined to d2b-owned table.".to_owned(),
        },
        NegativeMatrixCase {
            class: NegativeMatrixClass::NftBatchApply,
