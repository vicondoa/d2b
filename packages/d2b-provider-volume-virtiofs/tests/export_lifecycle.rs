...
fn an_export_naming_an_undeclared_view_is_rejected() {
    let export = ExportSpec::new(
        ...
        d2b_contracts::v3::volume::AttachmentAccess::ReadOnly,
        d2b_contracts::v3::volume::AttachmentSettings::default(),
    )
...
fn a_virtio_blk_attachment_is_not_translated_into_an_export() {
    let attachment: d2b_contracts::v3::volume::VolumeAttachment =
