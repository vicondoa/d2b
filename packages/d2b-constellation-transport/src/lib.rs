//! `d2b-constellation-transport` (ADR 0032): the transport-trait home
...
//! `d2b-constellation-provider` + `async-trait`/`tokio`. It MUST NOT
...
use d2b_constellation_core::{NodeId, ProviderId};
