...
use d2b_constellation_provider::ProtocolCodec;
...
fn decode_capability_negotiation(
    ...
    if schema_version != d2b_constellation_core::capability::CAPABILITY_NEGOTIATION_SCHEMA_VERSION {
        ...
        let encoded = ProtoFrame {
            body: Some(proto_frame::Body::Handshake(ProtoHandshake {
                ...
                capability_schema_version:
                    d2b_constellation_core::capability::CAPABILITY_NEGOTIATION_SCHEMA_VERSION,
