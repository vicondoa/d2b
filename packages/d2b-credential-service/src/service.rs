//! Strict DTO, admission, and sensitive-record contracts for the service.

use core::fmt;
use std::sync::atomic::{AtomicU8, Ordering};

use d2b_contracts::v3::component_session::MAX_PROTECTED_PLAINTEXT_BYTES;
use d2b_contracts::v3::credential::{
    AudienceToken, CredentialLeaseHandle, CredentialLeaseState, CredentialSourceVersion,
    OperationClass,
};
use d2b_contracts::v3::{ResourceGeneration, ResourceRef, ResourceUid, TranscriptHash};
...
impl DeliveryRouteDigest {
    ...
    pub fn parse(value: impl Into<String>) -> Result<Self, CredentialServiceError> {
        ...
        let valid = value.len() == ROUTE_DIGEST_BYTES
